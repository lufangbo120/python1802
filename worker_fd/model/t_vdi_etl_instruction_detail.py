...
class TVdiEtlInstructionDetail(Base):
    __tablename__ = 't_vdi_etl_instruction_detail'

    key_etl_instruction = Column(VARCHAR(50))
    id_ind_port_code = Column(VARCHAR(30), primary_key=True)
    ...
    def __str__(self):
        return  str(self.key_etl_instruction)+'$*'+str(self.vc_md5)
