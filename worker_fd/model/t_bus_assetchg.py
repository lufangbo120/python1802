...
class TBusAssetchg(Base):
    __tablename__ = 't_bus_assetchg'
    ...
    def __str__(self):
        return  str(self.c_business_type)+str(self.en_total_cost)+str(self.c_fund_code)+str(self.en_turnover_share)+'$*'+str(self.vc_md5)