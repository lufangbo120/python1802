...
class TBscFundtype(Base):
    __tablename__ = 't_bsc_fundtype'
    ...
    def __str__(self):
        return  str(self.l_type_no)+str(self.vc_scode)+str(self.l_data_kind)+str(self.l_begin_date)+'$*'+str(self.vc_md5)