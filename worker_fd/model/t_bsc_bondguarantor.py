...
class TBscBondguarantor(Base):
    __tablename__ = 't_bsc_bondguarantor'
    ...
    def __str__(self):
        return  str(self.vc_company_code)+str(self.l_guarantor_type)+str(self.vc_scode)+str(self.l_guarant_kind)+'$*'+str(self.vc_md5)