...
class TBscInstitutioncredit(Base):
    __tablename__ = 't_bsc_institutioncredit'
    ...
    def __str__(self):
        return  str(self.vc_company_code)+str(self.l_begin_date)+str(self.l_end_date)+str(self.vc_ratecompany_code)+str(self.l_credit_type)+'$*'+str(self.vc_md5)