...
class TBscPsopreferstockIssue(Base):
    __tablename__ = 't_bsc_psopreferstock_issue'
    ...
    def __str__(self):
        return  str(self.vc_company_code)+str(self.l_publishdate)+str(self.vc_scode)+'$*'+str(self.vc_md5)