...
class TBscFuturequote(Base):
    __tablename__ = 't_bsc_futurequote'
    ...
    en_last_sprice = Column(VARCHAR(50))
    en_sprice = Column(VARCHAR(50))
    en_amount = Column(VARCHAR(50))
    en_volume = Column(VARCHAR(50))
    en_positions = Column(VARCHAR(50))
    ...
    def __str__(self):
        return  str(self.vc_scode)+str(self.l_trade_date)+'$*'+str(self.vc_md5)