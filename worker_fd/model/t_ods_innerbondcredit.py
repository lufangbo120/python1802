...
class TOdsInnerbondcredit(Base):
    __tablename__ = 't_ods_innerbondcredit'
    ...
    def __str__(self):
        return  str(self.vc_scode)+str(self.l_end_date)+str(self.l_begin_date)+str(self.l_rate_type)+'$*'+str(self.vc_md5)