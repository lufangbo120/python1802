...
class TBscPensionproduct(TDataMD5):

    def update_save(self):
        dict_data = self.config.conn_mysql.execute("select * from t_dictionary where l_dictionary_no = 10011")
...
regiest_task('TBscPensionproduct',TBscPensionproduct)
